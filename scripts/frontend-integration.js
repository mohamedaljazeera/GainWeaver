 ...
 * This file demonstrates how to integrate Gainweaver with a web frontend
 */

// For React/Vue/Angular applications
export class GainweaverClient {
    ...
    useEffect(() => {
        async function init() {
            try {
                ...
                const contractClient = new GainweaverClient(provider, contractAddress);
